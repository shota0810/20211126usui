        ...
        <form action="/find" method="GET">
            ...
            <div class="flex">
                ...
                <div class="input-gender">
                    ...
                    @elseif($gender==1)
                    <input id="button-1" class="radio" type="radio" name="gender" value=""><label for="button-1">全て</label>
                    <input id="button-2" class="radio" type="radio" name="gender" value=1  checked><label for="button-2">男性</label>
                    <input id="button-3" class="radio" type="radio" name="gender" value=2><label for="button-3">女性</label>
                    @else
                    <input id="button-1" class="radio" type="radio" name="gender" value=""><label for="button-1">全て</label>
                    <input id="button-2" class="radio" type="radio" name="gender" value=1><label for="button-2">男性</label>
                    <input id="button-3" class="radio" type="radio" name="gender" value=2 checked><label for="button-3">女性</label>
                    @endif
                </div>
            </div>
